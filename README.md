...
In file [default_project.xml](https://github.com/idea-statica/ccm-examples/blob/master/FEAppExample_1/default_project.xml) there is example how to import member into CCM.
